		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    @endif
					<div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url(http://127.0.0.1:8000/frontend/assets/img/bg/breadcrumb.jpg)" width='100%'>
									...
									@forelse ($carts as $cart)
										...
										<tr>
											...
											<td class="product-thumbnail">
												<a href="{{ route('product.show', $product->slug) }}"><img src="http://127.0.0.1:8000/frontend/assets/img/product/book/1.jpg" alt="{{ $product->name }}" style="width:100px"></a>
											</td>
